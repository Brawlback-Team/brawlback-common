...
/* ======== Rollback ======== */
const s32 MAX_ROLLBACK_FRAMES = 5;
const s32 FRAME_DELAY = 2;
...
const s32 FRAMEDATA_MAX_QUEUE_SIZE = 15; 
...
const s32 GAME_FULL_START_FRAME = 100;
// constexpr s32 MAX_REMOTE_PLAYERS = 3;
const s32 MAX_NUM_PLAYERS = 4;
// constexpr s32 BRAWLBACK_PORT = 7779;

/* ======== Timesync ======== */
// update ping display every X frames
const s32 PING_DISPLAY_INTERVAL = 30;
// check clock desynchronization every X frames
const s32 ONLINE_LOCKSTEP_INTERVAL = 30;
const s32 TIMESYNC_MAX_US_OFFSET = 10000; // 60% of a frame
